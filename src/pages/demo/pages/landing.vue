  ...
  <div class="surface-0 overflow-hidden">
    <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
      <NuxtLink to="/" class="flex align-items-center">
        <img :src="`/images/logo-${logoColor}.svg`" alt="Logo" height="50" class="mr-0 lg:mr-2"><span class="text-900 font-medium text-2xl line-height-3 mr-8">Nuxt</span>
      </NuxtLink>
      <a
        v-ripple
      ...
      <div class="surface-0 align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2" style="top:92%">
        <ul class="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer">
          <li>
            <a v-ripple class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#hero')">
              <span>Home</span>
            </a>
          </li>
          <li>
            <a v-ripple class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#features')">
              <span>Features</span>
            </a>
          </li>
          <li>
            <a v-ripple class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#highlight')">
              <span>Highlight</span>
            </a>
          </li>
          <li>
            <a v-ripple class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#pricing')">
              <span>Pricing</span>
            </a>
          </li>
        </ul>
        <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
          <Button label="Login" class="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500" @click="$router.push('/login')" />
      ...
      <div class="grid justify-content-center">
        ...
        <div class="col-12 mt-8 mb-8 p-2 md:p-8" style="border-radius:20px; background:linear-gradient(0deg, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.6)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, #EFE1AF 0%, #C3DCFA 100%);">
          <div class="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
            ...
            <img src="/images/peak-logo.svg" class="mt-4" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="highlight" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
      ...
      <div class="grid mt-8 pb-2 md:pb-8">
        <div class="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style="border-radius:8px;">
          <img src="/images/mockup.png" class="w-11" alt="mockup mobile">
        </div>
      ...
      <div class="grid my-8 pt-2 md:pt-8">
        ...
        <div class="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style="border-radius:8px;">
          <img src="/images/mockup-desktop.png" class="w-11 pt-4" alt="mockup">
        </div>
      </div>
    </div>
      ...
      <div class="grid justify-content-between mt-8 md:mt-0">
        <div class="col-12 lg:col-4 p-0 md:p-3">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200" style="border:2px solid; border-radius:10px;">
            <h3 class="text-900 text-center">
              Free
            </h3>
            <img src="/images/asset-tier-1.svg" class="w-10 h-10 mx-auto" alt="">
            <div class="my-5 text-center">
              <span class="text-5xl font-bold mr-2 text-900">$0</span>
              <span class="text-600">per month</span>
              <Button label="Get Started" class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light text-white line-height-2 bg-blue-500" />
            </div>
        ...
        <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200" style="border:2px solid; border-radius:10px;">
            ...
            <img src="/images/asset-tier-2.svg" class="w-10 h-10 mx-auto" alt="">
            <div class="my-5 text-center">
              <span class="text-5xl font-bold mr-2 text-900">$1</span>
              <span class="text-600">per month</span>
              <Button label="Try Free" class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light text-white line-height-2 bg-blue-500" />
            </div>
            <Divider class="w-full bg-surface-200" />
            <ul class="my-5 list-none p-0 flex text-900 flex-column">
              <li class="py-2">
        ...
        <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200" style="border:2px solid; border-radius:10px;">
            ...
            <img src="/images/asset-tier-3.svg" class="w-10 h-10 mx-auto" alt="">
            <div class="my-5 text-center">
              <span class="text-5xl font-bold mr-2 text-900">$999</span>
              <span class="text-600">per month</span>
              <Button label="Get a Quote" class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light text-white line-height-2 bg-blue-500" />
            </div>
            <Divider class="w-full bg-surface-200" />
            <ul class="my-5 list-none p-0 flex text-900 flex-column">
              <li class="py-2">
      ...
      <div class="grid justify-content-between">
        <div class="col-12 md:col-2" style="margin-top:-1.5rem;">
          <div class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3">
            <img
              :src="`/images/logo-${logoColor}.svg`" alt="footer sections" width="50"
              height="50"
              class="mr-2"
            >
        ...
        <div class="col-12 md:col-7">
          <div class="grid text-center md:text-left">
            ...
            <div class="col-12 md:col-3 mt-4 md:mt-0">
              ...
              <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Events<img src="/images/new-badge.svg" class="ml-2"></a>
